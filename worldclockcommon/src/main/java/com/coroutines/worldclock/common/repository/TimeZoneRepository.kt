...
class TimeZoneRepository(
  ...
  val selectedTimeZoneId: Flow<String> =
    watchPreferencesRepository.selectedTimeZoneId.map {
      it ?: timeZoneService.getCurrentTimeZoneId()
    }

  // Get the selected time zone info
  val selectedTimeZoneInfo: Flow<TimeZoneInfo> =
    selectedTimeZoneId.map { id ->
