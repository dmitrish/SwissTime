...
/** A live wallpaper service that displays the Zeitwerk watch face. */
class ZeitwerkWallpaperService : WallpaperService() {

  override fun onCreateEngine(): Engine {
    return ClockEngine()
  }

  /** The engine that handles rendering the Zeitwerk watch face. */
  inner class ClockEngine : Engine() {
    private val handler = Handler(Looper.getMainLooper())
    private var visible = false
    private lateinit var clock: ZeitwerkClock
    ...
    override fun onCreate(surfaceHolder: SurfaceHolder) {
      ...
      clock = ZeitwerkClock(this@ZeitwerkWallpaperService, handler)
    }
