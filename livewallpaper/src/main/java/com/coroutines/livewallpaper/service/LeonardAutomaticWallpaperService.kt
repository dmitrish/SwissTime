...
/**
 * A live wallpaper service that displays the Leonard Automatic watch face.
 */
class LeonardAutomaticWallpaperService : WallpaperService() {
    ...
    /**
     * The engine that handles rendering the Leonard Automatic watch face.
     */
    inner class ClockEngine : Engine() {
        private val handler = Handler(Looper.getMainLooper())
        private var visible = false
        private lateinit var clock: LeonardAutomaticClock
        ...
        override fun onCreate(surfaceHolder: SurfaceHolder) {
            ...
            clock = LeonardAutomaticClock(this@LeonardAutomaticWallpaperService, handler)
        }
