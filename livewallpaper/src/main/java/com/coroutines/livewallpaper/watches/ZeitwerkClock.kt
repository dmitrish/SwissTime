...
class ZeitwerkClock(private val context: Context, private val handler: Handler) : BaseClock {
  ...
  private fun drawClockFace(canvas: Canvas, centerX: Float, centerY: Float, radius: Float) {
    ...
    // Draw "Zeitwerk" text
    canvas.drawText("Zeitwerk", centerX, centerY - radius * 0.28f, logoPaint)

    // Draw "Alpenglühen" text
    canvas.drawText("Alpenglühen", centerX, centerY - radius * 0.13f, locationPaint)

    // Draw "ZEIT" text
    canvas.drawText("ZEIT", centerX, centerY + radius * 0.4f, modelPaint)

    // Draw "AUTOMATIC" text
    canvas.drawText("AUTOMATIC", centerX, centerY + radius * 0.6f, subModelPaint)
    ...
    canvas.drawText(day, dateX, dateY + radius * 0.035f, datePaint)
  }
  ...
  private fun drawClockHands(canvas: Canvas, centerX: Float, centerY: Float, radius: Float) {
    ...
    val hourHandRect =
      RectF(centerX - radius * 0.02f, centerY - radius * 0.5f, centerX + radius * 0.02f, centerY)
    ...
    val minuteHandRect =
      RectF(centerX - radius * 0.015f, centerY - radius * 0.7f, centerX + radius * 0.015f, centerY)
