...
class AboutScreenThemeTest {
  ...
  fun testCardVisualProperties() {
    ...
    composeTestRule.setContent { MaterialTheme { AboutScreen() } }
    ...
    composeTestRule.onNode(hasTestTag("rate_app_section_card")).assertIsDisplayed()

    // Verify the rate app button
    composeTestRule.onNodeWithTag("rate_app_button").assertIsDisplayed()
