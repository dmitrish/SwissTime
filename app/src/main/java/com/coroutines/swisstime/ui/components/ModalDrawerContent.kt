  ...
  ModalDrawerSheet(drawerContainerColor = DarkNavy.darken(0.45f)) {
    Column(
      ...
      ListItem(
        ...
        leadingContent = {
          Icon(imageVector = Icons.Default.Numbers, contentDescription = "Version")
        }
      )
      ...
      ListItem(
        ...
        leadingContent = { Icon(imageVector = Icons.Default.Info, contentDescription = "About") }
      )
...
fun ModalDrawerContentPreview() {
  SwissTimeTheme(themeMode = ThemeMode.DAY, dynamicColor = false) { ModalDrawerContent() }
}
