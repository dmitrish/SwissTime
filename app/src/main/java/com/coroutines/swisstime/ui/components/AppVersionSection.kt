...
/**
 * A composable that displays the app version information and provides a button to check for
 * updates.
 *
 * This component:
...
fun AppVersionSection(modifier: Modifier = Modifier) {
  ...
  DisposableEffect(lifecycleOwner) {
    ...
    onDispose { lifecycleOwner.lifecycle.removeObserver(appUpdateManager) }
  }
