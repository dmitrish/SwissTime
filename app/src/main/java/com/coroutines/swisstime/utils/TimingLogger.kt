...
/**
 * Utility class for logging performance timing information. Used to measure the time between
 * tapping on the Chronomagus watch and the OptimizedWorldMapScreen being completely drawn.
 */
object TimingLogger {
