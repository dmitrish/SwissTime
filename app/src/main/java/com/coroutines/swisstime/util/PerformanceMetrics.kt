 ...
 * This class provides methods for tracking various performance metrics such as
 * page transitions, rendering times, and other performance-related data.
 */
object PerformanceMetrics {
     ...
     */
    fun recordMetric(category: String, name: String, durationMs: Long, metadata: Map<String, Any> = emptyMap()) {
