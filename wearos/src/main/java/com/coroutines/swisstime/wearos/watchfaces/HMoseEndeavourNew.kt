...
fun HMoserEndeavour(
  ...
  Box(modifier = modifier.fillMaxSize()) {
    ...
    BaseWatch(modifier = Modifier.fillMaxSize(), timeZone = timeZone, theme = HMoserTheme)
...
fun HMoserEndeavourNewPreview() {
  Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) { HMoserEndeavour() }
}
