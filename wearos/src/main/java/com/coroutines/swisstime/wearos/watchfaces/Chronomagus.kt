...
fun Chronomagus(
    ...
    Box(modifier = modifier.fillMaxSize()) {
        ...
        Canvas(modifier = Modifier.fillMaxSize()) {
            ...
            ChronomagusTheme.staticElementsDrawer.forEach { drawer ->
        ...
        Canvas(modifier = Modifier.fillMaxSize()) {
            ...
            rotate(hourAngle) {
                ChronomagusTheme.hourHandDrawer(center, radius)(this)
            }

            // Draw minute hand
            val minuteAngle = minute * 6f
            rotate(minuteAngle) {
                ChronomagusTheme.minuteHandDrawer(center, radius)(this)
            }

            // Draw second hand
            val secondAngle = second * 6f
            rotate(secondAngle) {
                ChronomagusTheme.secondHandDrawer(center, radius)(this)
            }
