...
private object AventinusClassiqueTheme : WorldClockWatchTheme() {
  ...
  private fun drawClockFace(center: Offset, radius: Float): DrawScope.() -> Unit = {
    ...
    // Draw the main face
    drawCircle(color = ClockFaceColor, radius = scaledRadius * 0.9f, center = center)
  }
  ...
  Box(modifier = modifier.fillMaxSize()) {
    ...
    Box(
      ...
      CustomWorldMapWithDayNight(
        ...
        nightOverlayColor =
          Color(0xFFEEEEE0) // Use a light color for the night overlay to match the watch face
      )
    }
