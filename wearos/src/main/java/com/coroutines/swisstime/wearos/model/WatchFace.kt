...
fun getWatchFaceColor(watchName: String): androidx.compose.ui.graphics.Color {
    return when {
        watchName.contains("Valentinianus") -> androidx.compose.ui.graphics.Color(0xFFF5F5F5) // Silver-white dial
        watchName.contains("Centurio Luminor") -> androidx.compose.ui.graphics.Color(0xFF1E5631) // Green dial
        watchName.contains("Chronomagus") -> androidx.compose.ui.graphics.Color(0xFF000080) // Deep blue dial
        watchName.contains("Zenith El Primero") -> androidx.compose.ui.graphics.Color(0xFFF0F0F0) // Silver-white dial
