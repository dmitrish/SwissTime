...
private fun drawClockFace(center: Offset, radius: Float): DrawScope.() -> Unit = {
    ...
    for (i in 0 until 60) {
        ...
        if (i % 5 == 0) {
            ...
            val markerLength = if (i == 0) scaledRadius * 0.08f else scaledRadius * 0.06f // Bigger triangle at 12 o'clock
...
private fun drawHourMarkersAndNumbers(center: Offset, radius: Float): DrawScope.() -> Unit = {
    ...
    for (i in 1..12) {
        ...
        if (i == 12) {
            drawRect(
                color = MarkersColor,
                topLeft = Offset(center.x - scaledRadius * 0.06f, center.y - scaledRadius * 0.7f - scaledRadius * 0.06f),
            ...
            drawRect(
                color = LumeColor,
                topLeft = Offset(center.x - scaledRadius * 0.05f, center.y - scaledRadius * 0.7f - scaledRadius * 0.05f),
...
fun JurgsenZenithor(
    ...
    Box(modifier = modifier.fillMaxSize()) {
        ...
        Canvas(modifier = Modifier.fillMaxSize()) {
            ...
            JurgsenZenithorTheme.staticElementsDrawer.forEach { drawer ->
        ...
        Box(
            ...
            CustomWorldMapWithDayNight(
                modifier = Modifier
                    .fillMaxWidth(0.55f) // Make the map 55% of the available width
                    .fillMaxHeight(0.55f) // Make the map 55% of the available height while maintaining aspect ratio
        ...
        Canvas(modifier = Modifier.fillMaxSize()) {
            ...
            rotate(degrees = minute * 6f) {
                JurgsenZenithorTheme.minuteHandDrawer(center, radius)(this)
            }

            // Draw second hand
            rotate(degrees = second * 6f) {
                JurgsenZenithorTheme.secondHandDrawer(center, radius)(this)
            }
